...
import { AuthorAnalyticsComponent } from './components/author-analytics/author-analytics';
...
export const authorRoutes: Routes = [
  ...
  { path: 'analytics', component: AuthorAnalyticsComponent, canActivate: [authGuard] },
